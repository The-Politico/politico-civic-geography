...
class DivisionAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ("Names", {"fields": ("name", "label", "short_label")}),
        ("Reference codes", {"fields": ("code", "code_components")}),
        (
            "In effect",
            {"fields": ("effective", "effective_start", "effective_end")},
        ),
        ("Reference fields", {"fields": ("parent", "uid")}),
    )
...
class GeometryAdmin(admin.ModelAdmin):
    inlines = (PointInline,)
    list_display = ("division", "small_preview", "map_level", "series")
    list_filter = (
        "series",
        ("division__level", custom_titled_filter("division level")),
        ("subdivision_level", custom_titled_filter("map level")),
    )
